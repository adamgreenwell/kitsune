...
**Status:** Decided · 2026-09-07 · **Amended 2026-09-18** — the settings store landed with timezone as its first consumer; invalidation is automatic for every write through Eloquent, and the per-site cache is deferred. See the amendment after the consequences
