...
it('lists an orphan without removing it', function (): void {
    Storage::disk('local')->put('media/'.$this->org->getKey().'/2026/09/orphan.png', 'bytes');
    ...
    Storage::disk('local')->assertExists('media/'.$this->org->getKey().'/2026/09/orphan.png');
});

it('removes an orphan when forced', function (): void {
    $orphan = 'media/'.$this->org->getKey().'/2026/09/orphan.png';
    Storage::disk('local')->put($orphan, 'bytes');
...
it('looks at both the public and the private disk', function (): void {
    ...
    Storage::disk('local')->put('media/1/2026/09/priv.png', 'bytes');
